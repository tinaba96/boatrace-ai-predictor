    ...
    const faqs = [
        ...
        },
        {
            ...
            questions: [
                {
                    q: 'AI予測の精度はどのくらいですか？',
                    a: '2025年12月の実績では、複勝予測精度49.5%、3連複正解率12.8%です。詳細な実績は「成績」ページで公開しています。'
                },
                {
                ...
                },
                {
                    ...
                    a: 'それぞれ異なる特性でAI分析を行います。\n\n【スタンダード】バランス型：予測精度とパフォーマンスのバランスを重視。全国勝率・当地成績・モーター性能を総合的に評価します。迷ったらまずこれ。\n\n【本命狙い】安全型：予測精度を最重視。1号艇とA級選手を優先し、堅いレースで力を発揮します。初心者や堅実な予測をしたい方におすすめ。\n\n【穴狙い】高パフォーマンス型：高倍率予測を狙う。外枠の好モーターや展開の妙を重視し、荒れるレースで力を発揮します。'
                },
                {
                    q: 'どのモデルを選べば良いですか？',
                ...
                {
                    q: 'モデルごとの予測精度と効率性はどのくらい違いますか？',
                    a: '各モデルで異なる特徴があります（2025年12月実績）。\n\n【本命狙い】単勝予測精度53%、3連単正解率7%（安全志向）\n【スタンダード】単勝予測精度27%、3連単正解率3%、3連単効率性136%（バランス型）\n【穴狙い】単勝予測精度27%、3連複効率性333%（高パフォーマンス型）\n\n詳細な実績は「成績」ページでモデル別に確認できます。'
                }
            ]
        },
        {
            ...
            questions: [
                ...
                {
                    q: 'AI推奨、推奨買い目とは何ですか？',
                    a: 'AI推奨はAIが最も勝つ可能性が高いと分析した艇です。推奨買い目は、3連複や3連単の予測参考データです。'
                },
                {
                    q: '正解レースはどこで確認できますか？',
                    a: 'トップページの「正解レース」タブで、過去14日間の正解レースを確認できます。レース場別、期間別に絞り込むこともできます。'
                },
                {
                    q: 'シェア機能はありますか？',
        ...
        },
        {
            ...
            questions: [
                ...
                },
                {
                    ...
                    a: '複勝は予測精度49.5%で初心者向け、3連複は効率性80.6%で中級者向け、3連単は効率性134.3%で上級者向けの分析データです。'
                },
                {
                    q: 'AI予測は必ず正解しますか？',
                    a: 'いいえ、100%の正解はありません。AI予測は参考情報として提供しており、分析の一助としてご活用ください。'
                }
            ]
        },
        {
