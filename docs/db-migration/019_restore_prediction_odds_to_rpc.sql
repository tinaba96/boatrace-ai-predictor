-- Restore predictionOdds to RPC functions (BOA-51 リグレッション修正)
-- マイグレーション018で誤って削除されたpredictionOddsフィールドを復元
-- get_predictions_by_date と get_predictions_by_date_light の両関数に predictionOdds を再追加
